 ...
 * The `ConditionalOrder.nonce` is valid (i.e. the `ConditionalOrder` has not been executed before)
 * The `ConditionalOrder.signer` is valid (i.e. the `signer` is the owner or delegate of the account identified by the `ConditionalOrder.accountId`)
 * The provided `ConditionalOrder` signature is valid (i.e. the `ConditionalOrder` was signed by the `ConditionalOrder.signer`)
